...
> 小组成员、贡献比例与答辩安排见 **[CONTRIBUTION_MATRIX.md](CONTRIBUTION_MATRIX.md)**。本文档仅介绍**系统功能**与**运行方式**。
...
| 功能 | 路由 | 说明 |
| --- | --- | --- |
| **影片列表** | `/` | 按城市、影院、日期、片名筛选场次；表格展示片名、简介、演员、类型、分级、影院、银幕、日期、起止时间、时段与余座。 |
