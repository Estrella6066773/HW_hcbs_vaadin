...
public final class HcbsMediaCatalog {
    ...
    public static List<FilmSeed> extendedFilms() {
        return List.of(
                new FilmSeed("Midnight", "Midnight Courier",
                        "A night-shift driver uncovers a smuggling ring along the Thames.",
                        "Thriller", "15", 4.5, 110, "/images/posters/midnight-courier.svg"),
                new FilmSeed("Velvet", "Velvet Compass",
                        "Two musicians reunite on a cross-country train journey.",
                        "Romance", "12A", 4.2, 102, "/images/posters/velvet-compass.svg"),
                new FilmSeed("Iron", "Iron Tempest",
                        "An ex-pilot is pulled back into service for one final storm rescue.",
                        "Action", "12A", 4.7, 125, "/images/posters/iron-tempest.svg"),
                new FilmSeed("Lantern", "Lantern Folk",
                        "Animated fable about village lanterns that guide lost travellers.",
                        "Animation", "U", 4.8, 98, "/images/posters/lantern-folk.svg"),
                new FilmSeed("Quiet", "Quiet Room 7",
                        "A hotel night clerk discovers guests who never checked out.",
                        "Horror", "15", 4.0, 99, "/images/posters/quiet-room-7.svg"),
                new FilmSeed("North", "Northbound",
                        "Teenagers hike the Brecon Beacons and find a hidden valley.",
                        "Adventure", "12A", 4.3, 115, "/images/posters/northbound.svg"),
                new FilmSeed("Paper", "Paper Throne",
                        "A satirical comedy about a local council election in a seaside town.",
                        "Comedy", "12", 4.1, 108, "/images/posters/paper-throne.svg")
        );
    }
